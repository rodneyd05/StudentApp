...
class AssignmentAdapter(private var list: List<Content>): RecyclerView.Adapter<AssignmentAdapter.AssignmentHolder>() {

    class AssignmentHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
